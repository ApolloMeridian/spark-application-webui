...
function AdminRoute() {
  ...
  return session?.role === 'admin' ? <Outlet /> : <Navigate to="/overview" replace />;
}

function LocalAccountRoute() {
  return runtimeConfig.auth.mode === 'local' ? <Outlet /> : <Navigate to="/overview" replace />;
}
            ...
            <Route element={<ProtectedRoute />}>
              <Route element={<AppShell />}>
                ...
                <Route element={<AdminRoute />}>
                  ...
                  <Route element={<LocalAccountRoute />}><Route path="/users" element={<UsersPage />} /></Route>
                </Route>
              </Route>
            </Route>
