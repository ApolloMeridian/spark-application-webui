...
export function AuditPage() {
  ...
  const columns: ColumnsType<OperationAudit> = [
    { title: t('timestamp'), dataIndex: 'timestamp', width: 190, render: (v) => dayjs(v).format('YYYY-MM-DD HH:mm:ss') },
    ...
    { title: t('auditOperator'), dataIndex: 'operator', width: 130 }, { title: t('operation'), dataIndex: 'operation', width: 110, render: (v) => <Tag color="red">{v}</Tag> },
