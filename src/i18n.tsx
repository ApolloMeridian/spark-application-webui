...
const messages = {
  'zh-CN': {
    ...
    yamlEditor: 'SparkApplication YAML 编辑器', yamlHint: '填写完整的 SparkApplication YAML，并通过后端 ServiceAccount 提交到所选命名空间。', loadExample: '加载示例', submitToCluster: '提交到集群', submissionSuccess: 'SparkApplication 已提交', submitNoPermission: '当前角色没有提交作业的权限', validateManifest: '校验并预览', dryRunSuccess: 'Kubernetes Dry Run 校验通过', manifestDiff: '提交变更预览', originalManifest: '原始 YAML', serverManifest: '服务端规范化 YAML', validationRequired: '提交前请先执行 Dry Run 校验',
    cloneApplication: '克隆作业', retryApplication: '重试作业', preparedFrom: '来源作业', lifecycle: '生命周期', diagnosis: '失败诊断', historicalSnapshot: '历史快照', recommendation: '建议',
    ...
    userManagement: '用户管理', userManagementHint: '创建管理员或只读用户，并管理账号状态和密码。', createUser: '创建用户', editUser: '编辑用户', deleteUser: '删除用户', deleteUserConfirm: '确认删除这个用户？', namespaceAccess: '命名空间权限', namespaceAccessHint: '留空表示可访问 Helm 中配置的全部命名空间。',
  ...
  'en-US': {
    ...
    yamlEditor: 'SparkApplication YAML editor', yamlHint: 'Enter a complete SparkApplication manifest and submit it with the backend ServiceAccount.', loadExample: 'Load example', submitToCluster: 'Submit to cluster', submissionSuccess: 'SparkApplication submitted', submitNoPermission: 'Your role cannot submit applications', validateManifest: 'Validate & preview', dryRunSuccess: 'Kubernetes dry run accepted', manifestDiff: 'Submission diff', originalManifest: 'Original YAML', serverManifest: 'Server-normalized YAML', validationRequired: 'Run dry-run validation before submitting',
    cloneApplication: 'Clone application', retryApplication: 'Retry application', preparedFrom: 'Prepared from', lifecycle: 'Lifecycle', diagnosis: 'Failure diagnosis', historicalSnapshot: 'Historical snapshot', recommendation: 'Recommendation',
    ...
    userManagement: 'User management', userManagementHint: 'Create administrators or read-only users and manage account status and passwords.', createUser: 'Create user', editUser: 'Edit user', deleteUser: 'Delete user', deleteUserConfirm: 'Delete this user?', namespaceAccess: 'Namespace access', namespaceAccessHint: 'Leave empty to allow every namespace configured by Helm.',
