...
const messages = {
  'zh-CN': {
    ...
    copy: '复制', copied: '已复制', killSuccess: '作业终止请求已提交', deleteSuccess: '终态作业删除请求已提交', historicalSubmitted: '历史提交', historicalFailed: '历史失败', historyRange: '统计时间范围',
  },
  'en-US': {
    ...
    copy: 'Copy', copied: 'Copied', killSuccess: 'Kill request submitted', deleteSuccess: 'Delete request submitted', historicalSubmitted: 'Historical submissions', historicalFailed: 'Historical failures', historyRange: 'Statistics range',
  },
} as const;
